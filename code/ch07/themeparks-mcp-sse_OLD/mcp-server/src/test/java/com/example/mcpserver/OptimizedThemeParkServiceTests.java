...
import static com.example.mcpserver.api.SimpleThemeParkService.Park;
...
@RestClientTest(SimpleThemeParkService.class)
public class OptimizedThemeParkServiceTests {

  @Autowired
  private SimpleThemeParkService themeParkService;
